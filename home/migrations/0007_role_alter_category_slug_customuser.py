...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('home', '0006_alter_category_options_remove_category_posts_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='home.role')),
            ],
            options={
                'verbose_name': 'user',
